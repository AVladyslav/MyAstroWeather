 ...
 */
import com.example.anamariapaula.myastroweather.R;
...
public class basic extends Fragment {
    ...
    private basic.OnFragmentInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof basic.OnFragmentInteractionListener) {
            mListener = (basic.OnFragmentInteractionListener) context;
        } else {
